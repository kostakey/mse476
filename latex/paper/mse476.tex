...
\begin{document}
    ...
    \section{Materials Used in Electric Motors}
        ...
        \subsection{Permanent Magnet Materials}
            ...
            \begin{center}
                \includegraphics[width=0.5\textwidth]{resources/energy product.png}
                \\
                \textbf{Figure 12: Energy Product Between the Maximum Energy Product of Differing Hard Magnetic Materials} \autocite{WIDMER20157}
                \label{energy product}
            \end{center}

        \subsection{Conductive Materials}
        \subsection{Structural Materials}
        \subsection{Electrical Insulation}
